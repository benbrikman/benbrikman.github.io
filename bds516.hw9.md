...
```
    ...
    NaiveBayes Tfidf Score:  0.5921787709497207
    NaiveBayes Count Score:  0.5977653631284916
...
![png](output_10_0.png)
    ...
    [(-1.633396387027869, 'amp'),
     (-0.8780100922490912, 'paper'),
     (-0.26191427862260935, 'time'),
     (0.06696934096845952, 'just'),
     (0.07935594228823761, 'https'),
     (0.17413976669530634, 'don')]
...
```
    ...
    Prediction for tweet: RT @chayniaa: how i feel every time i listen to call me by your name https://t.co/BeL5ny4XjO: ['eugen_dimant']
